...
void setup() {
  ...
  backSettings = new Button(width-75, height-37.5, 150, 75, BLACK, GREEN, new ScreenChangeEvent(saveScreen), "Back", BLACK, 22);
  backMenu = new Button(width-75, height-37.5, 150, 75, BLACK, GREEN, new ScreenChangeEvent(Screens.MENU), "Back", BLACK, 22);
  cornerBack = new Button(width-75, 37.5, 150, 75, BLACK, GREEN, new ScreenChangeEvent(Screens.MENU), "Back", BLACK, 22);
